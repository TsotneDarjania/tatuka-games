...
export default class MusicPlayer {
    ...
    addSongs(){
        //Georgian Radio
        const mtawmindaSong = this.scene.sound.add('mtawmindaSong',{volume: 0.1});
    ...
    playObsticaleSong(index : number){
    ...
    playSong(){
        const index = Math.floor(getRandomFloat(0,this.radios[this.radioIndex].length - 1))
