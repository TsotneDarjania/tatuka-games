...
export class Angel extends Phaser.GameObjects.Container{
    ...
    addHead(){
        const head = this.scene.add.image(0,300,"angelHead")
        .setScale(0.8);
    ...
    addWings(){
        // Left Wing
        const leftWing = this.scene.add.image(-90,400,"angelWing")
        .setScale(0.67);
        ...
        // Right Wing
        const rightWing = this.scene.add.image(90,400,"angelWing")
        .setScale(0.67)
        .setFlip(true,false)
    ...
    addBody(){
        const body = this.scene.add.image(0,387,"angelBody")
        .setScale(1.1);
        this.add(body)
